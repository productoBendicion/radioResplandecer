...
public class VdeeBilingueAdapter extends RecyclerView.Adapter<VdeeBilingueAdapter.AudioViewHolder> {
    ...
    public void updateVdeeAudios(ArrayList<Audio> audioList) {
